...
function page() {
  ...
  return (
    <main className="w-full">
      ...
      <section className='w-10/12 flex flex-col md:flex-row mx-auto my-10'>
        <iframe className='hidden md:flex' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d435912.82546369446!2d-64.52316931405804!3d-31.39844705868742!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9432985f478f5b69%3A0xb0a24f9a5366b092!2zQ8OzcmRvYmE!5e0!3m2!1ses-419!2sar!4v1701523180236!5m2!1ses-419!2sar" width="500" height="350" style={{ border: 0 }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <div className='mx-auto md:pl-4 my-4 lg:my-0 lg:mr-4'>
          <h2 className='text-3xl uppercase'>contactanos</h2>
          <ul>
            <li>WhatsApp: 112233997766</li>
            <li>Facebook: <a href="" target='blank'>pa'l alma dibujos</a></li>
            <li>Instagram: <a href="" target='blank'>pa.l.alma.dibujos</a></li>
            <li>Email: <a href="" target='blank'>pal.l.alma.dibujos@gmail.com</a></li>
            <li>Ubicación: Córdoba Capital</li>
          </ul>
        </div>
      </section>
