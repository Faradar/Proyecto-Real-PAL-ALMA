...
function page() {
  return (
    <main className="w-full">
      ...
      <Image src={verdeBorde} width={300} className="flex absolute top-10 right-0"/>
      <Image src={miceVerde} width={230} className="flex absolute top-32 right-0"/>
      </div>
      <section className="w-10/12 lg:w-8/12 flex flex-col md:flex-row mx-auto my-10">
        <iframe className="hidden md:flex lg:w-1/2" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3405.6084521077305!2d-64.25286542405686!3d-31.397358174270547!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94329f4f9b39a933%3A0xdca784a664308b33!2sAv.%20Duarte%20Quir%C3%B3s%205223%2C%20C%C3%B3rdoba!5e0!3m2!1ses-419!2sar!4v1702330800472!5m2!1ses-419!2sar" width={500} height={450} style={{ border: 0 }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      ...
      <div className="hidden lg:flex absolute z-[-10]">
      <Image src={azulBorde} width={340} className="flex  relative left-0"/>
      <Image src={miceAzul} width={150} className="flex absolute top-28 left-0"/>
      </div>
      <Form />
    </main>
  );
