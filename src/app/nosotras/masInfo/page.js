    ...
    <>
      ...
      <main className='w-10/12 mx-auto my-4 overflow-x-hidden  bg-slate-50/20'>
        ...
        <div className="hidden lg:flex absolute left-0 top-full z-[-10]">
          <Image src={verdeBorde2} width={400} className="flex relative  top-[450px] left-24" alt='borde de micelania verde 2'/>
          <Image src={miceVerde2} width={370} className="flex absolute top-[450px] z-[-10] left-28" alt='micelania verde' />
        </div>
      </main>
    </>
  )
