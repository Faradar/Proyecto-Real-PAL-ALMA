    ...
    <>
      ...
      <main className='w-10/12 mx-auto my-4 overflow-x-hidden  bg-slate-50/30'>
        <div className='grid grid-rows-3 lg:grid-cols-2 lg:grid-rows-1'>
          <Image src={mari} className='w-11/12 md:w-9/12 flex justify-self-center m-auto' />
        ...
        <div className='grid grid-rows-3 lg:grid-cols-2 lg:grid-rows-1'>
          <Image className='lg:order-last w-9/12 flex justify-self-center m-auto' src={pato} />
        ...
        <div className="hidden lg:flex absolute left-0 top-full z-[-10]">
          <Image src={verdeBorde2} width={430} className="flex relative  top-[550px] left-24" />
          <Image src={miceVerde2} width={400} className="flex absolute top-[550px] z-[-10] left-28" />
        </div>
      </main>
    </>
  )
