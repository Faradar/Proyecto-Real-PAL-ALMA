...
function page() {
  return (
    <main>
      ...
      <Link href="/nosotras/masInfo" className='w-9/12 text-center flex justify-center mx-auto uppercase m-10 py-4 bg-orange-600 rounded-xl text-white hover:bg-orange-700'>Más sobre nosotras</Link>
    </main>
