...
export default function Home() {
  ...
  return (
    <main>
      <section className="grid grid-cols-12 justify-center bg-slate-700/10 shadow-[0_6px_6px_-1px_rgba(0,0,0,0.3)] overflow-y-hidden">
        <div className="w-32 md:w-44 lg:w-48 grid z-10">
          <Image
          ...
          />
          <div className="grid absolute w-28 md:w-40 md:top-28 lg:w-48">
            <Image
        ...
        <div className="flex flex-col text-center w-full col-span-10 relative mx-0 px-0">
          <h1 className="font-semibold md:text-3xl">Bienvenidos!</h1>
          <Image
            src={logo}
            width={182}
            height={200}
            className="mx-auto md:w-11/12 lg:w-12/12"
            alt="logo de pa'l alma grande"
          />
          <p className="text-xs md:text-base font-semibold py-2 w-64 mx-auto">
        ...
        <div className="w-28 md:w-28 lg:w-40 grid justify-end absolute top-32 lg:top-24 md:top-28 right-[-30px]">
          <Image
          ...
          />
          <div className="w-24 md:w-32 lg:w-36 grid relative bottom-[190px] md:bottom-80 md:right-14 lg:bottom-96 lg:right-16 right-0">
            <Image
      ...
      <section className="w-11/12 mx-auto mb-10">
        ...
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
          <Link href="/productos">
            <HomeCard
              src={llavero}
              title={"Llavero rectangular Lechuza vizcachera"}
            />
          </Link>
          <Link href="/productos">
            <HomeCard
              src={taza}
              title={"Taza cerámica, diseño con Dientes de León"}
            />
          </Link>
          <Link href="/productos">
            <HomeCard src={calcomanias} title={"Calcamonías Flora autóctona"} />
          </Link>
          <Link href="/productos">
            <HomeCard src={botella} title={"Botella con diseño de Mariposa"} />
          </Link>
