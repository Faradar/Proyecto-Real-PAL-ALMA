...
function HomeCard({ src, title }) {
  return (
    <article className="group w-[230px] h-[230px] md:w-[290px] md:h-[310px] lg:w-[325px] lg:h-[325px] xl:w-[350px] xl:h-[350px] bg-[#EAF0F4] m-2 mt-5 mx-auto rounded-xl flex flex-col justify-start text-center text-xs md:text-sm xl:text-md overflow-hidden hover:bg-transparent hover:text-transparent ease-out duration-200 shadow-[0_6px_6px_-1px_rgba(0,0,0,0.3)] hover:shadow-none">
      <Image
        src={src}
        alt={title}
        width={200}
