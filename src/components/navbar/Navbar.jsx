  ...
  return (
    <nav className="bg-slate-700/10 md:bg-white h-20 flex items-center justify-between pl-4 md:h-[100px] md:justify-around md:shadow-[0_6px_6px_-1px_rgba(0,0,0,0.3)] md:px-0">
      ...
      <div className="hidden md:flex justify-between items-center w-[630px] mx-auto font-semibold text-sm text-white">
        <div className="relative w-[110px] h-[92px] hover:opacity-60">
        ...
        <div className="relative w-[119px] h-[92px] hover:opacity-60">
          <div className="z-10 w-full h-full absolute">
            <Link
              href="/productos"
              className="flex justify-center items-center w-full h-full"
        ...
        <div className="relative w-[125px] h-[88px] hover:opacity-60">
          <div className="z-10 w-full h-full absolute ">
            <Link
              href="/talleres"
              className="flex justify-center items-center w-full h-full"
        ...
        <div className="relative w-[114px] h-[92px] hover:opacity-60">
          <div className="z-10 w-full h-full absolute ">
            <Link
              href="/nosotras"
              className="flex justify-center items-center w-full h-full"
        ...
        <div className="relative w-[113px] h-[88px] hover:opacity-60">
          <div className="z-10 w-full h-full absolute ">
            <Link
              href="/contacto"
              className="flex justify-center items-center w-full h-full"
      ...
      <div className="flex justify-between w-[30vw] max-w-[50px] md:w-auto">
        ...
        >
          ...
          >
            ...
            <Link href="/productos" className="py-2">
              Productos
            </Link>
            <Link href="/talleres" className="py-2">
              Talleres
            </Link>
            <Link href="/nosotras" className="py-2">
              Nosotras
            </Link>
            <Link href="/contacto" className="py-2">
              Contacto
            </Link>
          </div>
        </button>
      ...
      {/* Whatsapp */}
      <div className="p-2 order-last mr-2">
